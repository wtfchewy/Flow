        ...
        <div className="flex flex-col w-full h-screen">
            ...
            <div className="px-10 mt-8 flex flex-col w-1/3">
                ...
                <div className="flex flex-row mt-3 bg-foreground p-3 rounded-lg gap-3">
                    ...
                    <button onClick={() => setTheme('bluey')} className="w-8 h-8 rounded-full bg-[#111d22] border border-border hover:border-primary hover:border-2 hover:-translate-y-1 transition-transform duration-200"/>
                    <button onClick={() => setTheme('reptile')} className="w-8 h-8 rounded-full bg-[#141f18] border border-border hover:border-primary hover:border-2 hover:-translate-y-1 transition-transform duration-200"/>
                </div>
