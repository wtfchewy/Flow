    ...
    <nav className=" inset-x-0 z-50 backdrop-blur-lg bg-surface/50">
      <div className="px-10 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <a className="group inline-flex items-center justify-center outline-hidden transition duration-300 hover:bg-text/5 focus:ring-2 focus:ring-brand/90 rounded-2xl px-5 py-4 text-lg font-bold not-sm:bg-text/5" href="/Peak/app" aria-label="New Note">
